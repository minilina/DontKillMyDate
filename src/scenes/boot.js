...
import npcOrejas1NinfaElfoHada from '../../assets/sprites/npcs/orejas_1_ninfa_elfo_hada.png';
import npcOrejas2NinfaElfoHada from '../../assets/sprites/npcs/orejas_2_ninfa_elfo_hada.png';
import npcOrejas3NinfaElfoHada from '../../assets/sprites/npcs/orejas_3_ninfa_elfo_hada.png';
...
export default class Boot extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('orejas_1_ninfa_elfo_hada', npcOrejas1NinfaElfoHada);
        this.load.image('orejas_2_ninfa_elfo_hada', npcOrejas2NinfaElfoHada);
        this.load.image('orejas_3_ninfa_elfo_hada', npcOrejas3NinfaElfoHada);
